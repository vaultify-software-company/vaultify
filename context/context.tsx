...
interface ChatbotUIContext {
  ...
  // Add this inside the ChatbotUIContext interface
  profiles: Tables<"profiles">[]
  setProfiles: Dispatch<SetStateAction<Tables<"profiles">[]>>

  role: Tables<"roles"> | null
  setRole: Dispatch<SetStateAction<Tables<"roles"> | null>>

  admin: Tables<"profiles"> | null
  setAdmin: Dispatch<SetStateAction<Tables<"profiles"> | null>>

  // ORGANIZATION STORE
  organization: Tables<"organizations"> | null
  setOrganization: Dispatch<SetStateAction<Tables<"organizations"> | null>>
  ...
  updateItems: Tables<"files">[]
  setUpdateItems: Dispatch<SetStateAction<Tables<"files">[]>>
  ...
  useVellum: boolean
  setUseVellum: Dispatch<SetStateAction<boolean>>
  showLog: boolean
...
export const ChatbotUIContext = createContext<ChatbotUIContext>({
  ...
  // Add this inside the object passed to createContext
  profiles: [],
  setProfiles: () => {},
