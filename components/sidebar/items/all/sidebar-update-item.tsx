...
import { createProfile, deleteProfile, updateProfile } from "@/db/profile"
import { cancelButtonStyle, successButtonStyle } from "@/components/ui/styles"
...
export const SidebarUpdateItem: FC<SidebarUpdateItemProps> = ({
  ...
  const fetchWorkpaceFunctions: any = {
    ...
    profiles: async (profileId: string) => {
      const item = await getProfileWorkspacesByProfileId(profileId)
  ...
  const updateFunctions: any = {
    ...
    profiles: async (profileId: string, updateState: any) => {
      const updatedProfile = await updateProfile(
        profileId,
        updateState.personalDetails
      )

      const updatedWorkspace = await updateWorkspace(
        updateState.workspaceDetails.id,
        updateState.workspaceDetails
      )
